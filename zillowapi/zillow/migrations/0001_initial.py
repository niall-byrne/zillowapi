          ...
          fields=[
              ('id',
               models.AutoField(auto_created=True,
                                ...
                                verbose_name='ID')),
              ('area_unit',
               models.CharField(choices=[('SqFt', 'SqFt'),
                                         ('SqMeters', 'SqMeters')],
                                max_length=255)),
              ('bathrooms', models.DecimalField(decimal_places=1,
                                                max_digits=4)),
              ('bedrooms', models.DecimalField(decimal_places=1,
                                               max_digits=4)),
              ('home_size', models.DecimalField(decimal_places=2,
                                                max_digits=10)),
              ('home_type',
               models.CharField(choices=[
                   ('Apartment', 'Apartment'), ('Duplex', 'Duplex'),
              ...
              ('tax_value', models.DecimalField(decimal_places=2,
                                                max_digits=10)),
              ('tax_year',
               models.IntegerField(choices=[(2022, 2022), (2021, 2021),
                                            (2020, 2020), (2019, 2019),
                                            (2018, 2018), (2017, 2017),
                                            (2016, 2016), (2015, 2015),
                                            (2014, 2014), (2013, 2013),
